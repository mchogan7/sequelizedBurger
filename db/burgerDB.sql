...
CREATE TABLE `burgers` (
  ...
  `burger_date` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `burgers` VALUES (1,'Bacon Cheddar Burger',1,NULL),(2,'Chicken Ranch Burger',1,NULL),(3,'Gator Burger',1,NULL),(4,'Super Burger',1,NULL),(5,'Mega Burger',1,NULL);
...
-- Dump completed on 2017-02-11 18:38:06
